/**
 * RLC Bingo Manager - Google Apps Script Backend v96 - 2024-09-29
...
function doGet(e) {
  try {
    ...
    const BACKEND_INFO = {
      version: 'v11.2.0-admin-fixes',
      deployed: '2025-09-25T04:15:00Z',
      features: ['pull-tabs-library-152-games', 'session-games-68-total', 'cache-busting-support', 'pull-tab-crud-operations', 'enhanced-error-handling'],
      commit: 'f562a34'
    };
